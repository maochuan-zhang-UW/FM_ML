...
%load('/Users/mczhang/Documents/GitHub/FM5_ML/02-data/A_Wave/A_wave_noise_test.mat');
load('/Users/mczhang/Documents/GitHub/FM5_ML/02-data/A_wave/A_wave_dB20_cleaned.mat')
fields = {'AS1','AS2','CC1','EC1','EC2','EC3','ID1'};
figure('Position', [100, 100, 1800, 1200],'Color','w');
    ...
    for i = 1:length(Felix)
        ...
        if isfield(Felix(i), wave_field) && ~isequal(Felix(i).(wave_field), 0)
            ...
            if ~isempty(wave) && length(wave) > 1
                ...
                wave = resample(wave, 1, 2); % Resample from 200 Hz to 100 Hz
...
%sgtitle(sprintf('Template Waveforms form All Stations'));
...
sgtitle(sprintf('Template Signal and Noise Waveforms for All Stations'));
